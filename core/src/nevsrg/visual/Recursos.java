...
public class Recursos {
    ...
    public static final String JUDGE_PERFECT = "judgements/perfect.png";
    public static final String JUDGE_GREAT = "judgements/great.png";
    public static final String JUDGE_GOOD = "judgements/good.png";
    public static final String JUDGE_BAD = "judgements/bad.png";
    public static final String JUDGE_MISS = "judgements/miss.png";
