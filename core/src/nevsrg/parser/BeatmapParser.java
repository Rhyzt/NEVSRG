...
public abstract class BeatmapParser {
	protected IBuilderChart builder;
	
	public BeatmapParser(IBuilderChart builder) {
		this.builder = builder;
	}
	// Director del Builder, que tambien actua como parte del Template Method
	public final Nivel procesarMapa(String rutaArchivo) {
    ...
    protected abstract void procesarCancion();
